...
describe('update-profile', () => {
    beforeEach(() => {
      ...
      it('valid web format', () => {
        ...
        //when
        put_data_on_element(page_object_json.selectores["user-website-input"], faker.internet.url());

        ///Then

        click_on_element_and_focus(page_object_json.selectores['save-button']);
        validate_not_exist_on_element(page_object_json.selectores['error-user-web-site']);
      });
