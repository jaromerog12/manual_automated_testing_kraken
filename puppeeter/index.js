...
const post = require('./automated-tests/post');
...
(async () => {
    ...
    await general.Escenario14();
    await general.Escenario15();
    await post.Escenario16();
    await post.Escenario17();
    await post.Escenario18();
    await post.Escenario19();
    await post.Escenario20();
    return;
}
)();