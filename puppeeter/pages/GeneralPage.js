...
class GeneralPage {
    ...
    {
        await this.page.click('div.gh-app > div > main > section > div:nth-child(2) > div:nth-child(2) > section > div:nth-child(2) > div.gh-expandable-header > button');
        await new Promise(r => setTimeout(r, 5000));
    }

    async abrirDesplegableFacebook()
    {
        await this.page.click('div.gh-app > div > main > section > div:nth-child(2) > div:nth-child(2) > section > div:nth-child(3) > div.gh-expandable-header > button');
        await new Promise(r => setTimeout(r, 5000));
    }
