...
const Escenario5 = async () => {
    ...
    await pageObj.tomarImagen("6.publicacion");
    await pageObj.abrirPagina();
    await pageObj.tomarImagen("7.verificar");
    await pageObj.abrirPaginaNombre(pagePath[1]);
    await pageObj.tomarImagen("8.pagina_publicada");
}
...
const Escenario6 = async () => {
    ...
    await pageObj.tomarImagen("9.pagina_editada");

    await pageObj.updatePublicarPage();
    await pageObj.tomarImagen("10.confirmacion_publicacion");
    await pageObj.abrirPagina();
    await pageObj.tomarImagen("11.verificar");
    await pageObj.abrirPaginaNombre(pagePath[1]);
    await pageObj.tomarImagen("12.pagina_publicada");
}
...
const Escenario7 = async () => {
    ...
    await pageObj.tomarImagen("9.pagina");
    await pageObj.eliminarPage();
    await pageObj.tomarImagen("10.confirmar_eliminar");
    await pageObj.confirmarEliminarPage();
    await pageObj.tomarImagen("11.paginaEliminada");

    await pageObj.abrirPagina();
    await pageObj.tomarImagen("12.verificar");
    await pageObj.abrirPaginaNombre(pagePath[1]);
    await pageObj.tomarImagen("13.pagina_eliminada");
}
